...
defineSupportCode(function ({Given, Then, When}) {
    ...
    Then('FFC-0310 click on Formed Contribution Account page and Edit the payment method', async () => {
        await delay(15000);
        element(by.xpath(".//*[@id='account-nav']/ul/li[11]/a")).click();
        await delay(10000);
        element(by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/div/div[2]/div[3]/span[2]/a")).click();
        await delay(10000);
    });
    Then('FFC-0310 change the Monthly amount', async () => {
        await delay(15000);
        element(by.xpath(".//*[@id='md_savecard']/option[1]")).click();
        await delay(2000);
        element(by.xpath(".//*[@id='subscription_profile_update']/div/div[2]/div/p/a")).click();
        await delay(2000);
    });
    Then('FFC-0330 change the Contribution amount', async () => {
        await delay(15000);
        element(by.xpath(".//*[@id='change_recurring_amount_input']")).click();
        await delay(5000);
        element(by.xpath(".//*[@id='change_recurring_amount_input']")).sendKeys('1');
        await delay(5000);
	...
	Then('FFC-0330 changed Contribution amount is displayed', async () => {
		await delay(5000);
		await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[2]/div[2]/div[1]/div/div")).getText()).to.eventually.equal('Recurring contribution amount successfully changed from $100.00 to $1,010.00.');
		await delay(10000);
	});
	Then('ABP-0010 plan details are displayed', async () => {
		await delay(5000);
		await expect(browser.findElement(by.xpath("//a[@href='https://market.beta.formed.org/creditplans.html/']"))).to.eventually.exist;
		await delay(3000);
		await expect(browser.findElement(by.xpath(".//a[@href='https://market.beta.formed.org/customer/account/']"))).to.eventually.exist;
		await delay(3000);
	...
	When('ABP-0010 account overview is displayed', async () => {
		await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[1]/div[2]/div/p[2]/a[1]"))).to.eventually.exist;
		await delay(3000);
		await expect(browser.findElement(by.xpath(".//*[@id='cancel-credit-plan-btn']"))).to.eventually.exist;
		await delay(3000);
	});
	...
	Then('ABP-0030 payment method details is displayed', async () => {
		await expect(browser.findElement(by.xpath(".//*[@id='my-saved-cards-table']/tbody/tr[1]/td[5]/span/form[1]/a"))).to.eventually.exist;
		await delay(5000);
		await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[3]/button"))).to.eventually.exist;
		await delay(3000);                           
		element(by.xpath(".//*[@id='my-saved-cards-table']/tbody/tr[1]/td[5]/span/form[1]/a")).click();
		await delay(10000);
	});
	...
	Then('ABP-0050 credit plan details are displayed', async () => {
		...
		await expect(browser.findElement(by.xpath(".//*[@id='amasty-shopby-product-list']/div[1]/ul/li[2]/form/button"))).to.eventually.exist;
		await delay(3000);                                                                                             
		...
		await expect(browser.findElement(by.xpath(".//*[@id='my-orders-table']/tbody/tr[1]/td[6]/a/span"))).to.eventually.exist;
		await delay(3000);
		await expect(browser.findElement(by.xpath(".//*[@id='my-orders-table']/tbody/tr[1]/td[4]/span"))).to.eventually.exist;
		await delay(3000);
		element(by.xpath(".//*[@id='my-orders-table']/tbody/tr[1]/td[6]/a/span")).click();
		await delay(10000);
	});
		Then('ABP-0070 View details is displayed', async () => {
		await expect(browser.findElement(by.xpath(".//*[@class='order-number']"))).to.eventually.exist;
		await delay(3000);
		await expect(browser.findElement(by.xpath(".//*[@class='order-date']"))).to.eventually.exist;
		await delay(3000);
	});
	...
	When('Click on Product in Audio Books', async () => {
		await delay(10000);
...
Then('PBP-0070 Enter Shipping information', async () => { 
	await delay(20000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[4]/div/div[1]/div/div[2]/div/div[2]/form/div/fieldset/div/div[1]/div/input")).sendKeys("Chicago illonois");
	await delay(5000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[4]/div/div[1]/div/div[2]/div/div[2]/form/div/div[3]/div/input")).sendKeys("Chicago");
	await delay(1000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[4]/div/div[1]/div/div[2]/div/div[2]/form/div/div[5]/div/select")).click();
	await delay(1000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[4]/div/div[1]/div/div[2]/div/div[2]/form/div/div[5]/div/select/option[13]")).click();
	await delay(1000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[4]/div/div[1]/div/div[2]/div/div[2]/form/div/div[6]/div/input")).sendKeys("60014");
	await delay(5000);	
	element(by.xpath(".//*[@id='checkout-step-shipping']/div[5]/h2")).click();
	await delay(10000);
});
...
Then('PBP-0070 Verify the Checkout Page', async () => { 
	...
	await delay(5000);
	element(by.xpath(".//*[@id='checkout-step-review']/div[2]/div/button")).click();
	await delay(30000);
...
Then('PBP-0070 Click on purchase product in library page', async () => { 
	await expect(browser.findElement(by.xpath(".//*[@id='amasty-shopby-product-list']/div[2]/div/ol/li[1]/div/div/a/img"))).to.eventually.exist;
	await delay(10000);
	element(by.xpath(".//*[@id='amasty-shopby-product-list']/div[2]/div/ol/li[1]/div/div/a/img")).click();
	await delay(8000);
});
...
Then('CO-0010 Verify Check Out in Cart', async () => {
 ...
 Then('CO-0020 Cart should contain added products', async () => {
  ...
  When('PBC-0040 click on Entercupon', async () => {
	await delay(8000);
	...
	await delay(10000);
	await expect(browser.findElement(by.xpath(".//*[@id='opc-sidebar']/div[1]/div[2]/div[2]/div[1]/div/div/div/div/div")).getText()).to.eventually.equal('Your coupon was successfully applied.');
	await delay(5000);
});
Then('PBC-0100 TOTAL amount is displayed', async () => {
	await delay(5000);
	await expect(element(by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[2]/div[1]/div/div[9]/div[2]/strong/span")).getText()).to.eventually.equal("$625.00");
	await delay(10000);
});
...
When('VR-0020 Click on the create an account', async () => {
	...
	await expect(browser.findElement(by.xpath(".//*[@href='/customer/account/create?onSuccess=onestepcheckout']"))).to.eventually.exist;
	await delay(3000);
	element(by.xpath(".//*[@href='/customer/account/create?onSuccess=onestepcheckout']")).click();
	await delay(10000);
});
...
Then('CO-0100 Click on Apply credits', async () => {
    ...
    await delay(3000);
    element(by.xpath(".//*[@id='checkout-review-table']/tbody/tr[2]/td[2]/div/div/div[3]/label/span")).click();
    await delay(3000);
    await expect(browser.findElement(by.xpath(".//*[@id='checkout-review-table']/tbody/tr[2]/td[2]/div/div/div[3]/span"))).to.eventually.exist;
    await delay(1000);
    await expect(browser.findElement(by.xpath(".//*[@id='checkout-review-table']/tbody/tr[2]/td[2]/div/div/div[4]/button"))).to.eventually.exist;
    await delay(1000);
});
Then('FFC-0020 Navigate to community page', async () => {
	await delay(15000);
    element(by.xpath(".//*[@href='/community']")).click();
	await delay(20000); 
});
...
Then('FFC-0290 Enter Billing information', async () => {
	await delay(15000);
	element(by.xpath('html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/form/fieldset/fieldset/div/div[1]/div/input')).sendKeys('chicago illunious');
	await delay(2000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/form/fieldset/div[3]/div/input")).sendKeys('chicago');
	await delay(2000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/form/fieldset/div[5]/div/select")).click();
	await delay(2000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/form/fieldset/div[5]/div/select/option[13]")).click();
	await delay(2000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[2]/form/fieldset/div[6]/div/input")).sendKeys('60014');
	await delay(2000);
...
Then('FFC-0300 Order conformation page is displayed', async () => {
	await delay(3000);
    await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div/div[2]/strong/span"))).to.eventually.exist;
	await delay(2000);
	await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div/div[2]/strong"))).to.eventually.exist;
	await delay(2000);
	await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div/div[3]/dl/dd[2]"))).to.eventually.exist;
	await delay(2000);
});
...
When('FFC-0050 Enter the credit card Cvv number', async () => {
    await expect(browser.findElement(by.xpath(".//*[@id='formed-funding-info__graph']"))).to.eventually.exist;
	await delay(5000);
	element(by.xpath(".//*[@id='magedelight_cybersource_cc_cid']")).sendKeys('123');
	await delay(15000);
	element(by.xpath(".//*[@id='checkout-step-payment']/div/div[3]/div/button")).click();
...
Then('FFC-0070 click on View button in Account page', async () => {
	await delay(5000);
    await expect(element(by.xpath(".//*[@id='my-orders-table']/tbody/tr[1]/td[4]/span")).getText()).to.eventually.equal('$50.00');
	await delay(5000);
...
When('FFC-0090 Formed Funnding Contribution is displayed', async () => {
	await delay(5000);
	await expect(browser.findElement(by.xpath(".//*[@id='header']/div/div[3]/div/crowd-funding-widget/div/div/div[1]/a"))).to.eventually.exist;
	await delay(5000);
});
Then('CO-0100 click on apply credits', async () => {
...
Then('HPF-0020 market details are displayed', async () => {
	await expect(browser.findElement(by.xpath(".//*[@href='https://market.beta.formed.org/study.html']"))).to.eventually.exist;
	await delay(3000);
...
When('LP-0050 click on watch', async () => {
	element(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li/a/label/div[1]")).click();
	await delay(10000);
...
Then('LP-0050 watch purchased products are displayed', async () => {
	await expect(browser.findElement(by.xpath(".//*[@id='amasty-shopby-product-list']/div[4]/div/ol/li[1]/div/div/a/img"))).to.eventually.exist;
	await delay(3000);
	await expect(browser.findElement(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li/ol/li[1]/a/label/div[1]"))).to.eventually.exist;
	await delay(5000);
...
Then('LP-0060 click on play button', async () => {
	await delay(5000);
	element(by.xpath(".//*[@id='player-view']/resumeable-player/div[2]/div/div[1]/div[2]/a/i")).click();
	await delay(5000);
	element(by.xpath(".//*[@id='close-modal-mylibrary-player-1969']")).click();
	await delay(5000);
});
When('LP-0070 click on Listen', async () => {
	await expect(browser.findElement(by.linkText("Listen"))).to.eventually.exist;
...
When('LLP-0050 Click on account drop down for parish user', async  () => {
	element(by.xpath(".//*[@id='gigya-login-screen']/form/div/div[1]/div[1]/input")).sendKeys("yogirpatel@gmail.com");
	await delay(1000);
	element(by.xpath(".//*[@id='gigya-login-screen']/form/div/div[1]/div[2]/input")).sendKeys("zoro2017");
	await delay(1000);
	element(by.xpath(".//*[@id='gigya-login-screen']/form/div/div[2]/div/input[1]")).click();
	await delay(15000);
	element(by.xpath(".//*[@id='account-dropdown-button']")).click();
...
Then('LLP-0080 Subscription, Parish, Payment information are displayed', async  () => {
	...
	await delay(2000);
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/div/div/div/div/div/div[2]/div/div[1]/span"))).to.eventually.exist;
	await delay(2000);
});
...
Then('VR-0020 sign in group detail is displayed', async  () => {      
	...
	await expect(browser.findElement(by.xpath(".//*[@id='product-addtocart-button']"))).to.eventually.exist;
	await delay(2000);
	//element(by.xpath(".//*[@href='product-options-wrapper']/div/div[1]/div/label")).click();
	await delay(5000);
	element(by.xpath(".//*[@id='product-addtocart-button']")).click();
	await delay(10000);
});
...
Then('Billing amount shows in Account overview page and Ondemand subpanel', async () => {
	...
	await delay(10000);
	await expect(element(by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/div[1]/div/div[3]/span[2]")).getText()).to.eventually.equal('$625.00');
	await delay(5000); 
	await expect(element(by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[1]/div[4]/p[1]")).getText()).to.eventually.equal('$625.00');
	await delay(5000);            
});
...
Then('SGB-0020 agree for terms of Funding', async () => {
	await delay(8000);
	await expect(browser.findElement(by.xpath("html/body/div[3]/aside[2]/div[2]/footer/button[1]"))).to.eventually.exist;
    await delay(2000);
...
Then('SGB-0020 Set goal', async () => {
	await delay(3000);
	await expect(browser.findElement(by.xpath("html/body/div[3]/aside[1]/div[2]/footer/button[1]"))).to.eventually.exist;
    await delay(2000);
	element(by.xpath("html/body/div[3]/aside[1]/div[2]/footer/button[1]")).click();
	await delay(3000);
});
Then('VR-0040 Place Order button is displayed and click on place order button', async () => {
	await expect(browser.findElement(by.xpath(".//*[@id='checkout-step-review']/div[2]/div/button"))).to.eventually.exist;
	await delay(2000);
	element(by.xpath(".//*[@id='checkout-step-review']/div[2]/div/button")).click();
	await delay(30000);
});
...
When('VR-0050 click on Entercupon', async () => {
	await delay(8000);
	await expect(browser.findElement(by.xpath(".//*[@id='discount-code']"))).to.eventually.exist;
    await delay(2000);
});
...
When('VR-0060 Enter organization information', async () => {
	browser.navigate().refresh();
	await delay(30000);
	element(by.xpath(".//*[@id='groupLeader']")).sendKeys("KSCR");
	await delay(2000);
...
Then('SPP-0030 Search product page is displayed', async () => { 
	...
	await expect(browser.findElement(by.xpath(".//*[@id='amasty-shopby-product-list']/div[1]/ol/li[1]/div/a/img"))).to.eventually.exist;
	await delay(3000);
	await expect(browser.findElement(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[4]/a/label/div"))).to.eventually.exist;
	await delay(3000);            	   
 });
 ...
 Then('SPP-0040 Watch sub options are displayed', async () => {
	await delay(5000);
	await expect(browser.findElement(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[3]/ol/li[1]/a/label/div"))).to.eventually.exist;
	await delay(3000);
	await expect(browser.findElement(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[3]/ol/li[2]/a/label/div"))).to.eventually.exist;
	await delay(3000);
	await expect(browser.findElement(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[3]/ol/li[3]/a/label/div"))).to.eventually.exist;
	await delay(3000);
 });
 ...
 Then('SPP-0040 Listen sub options are displayed', async () => {
	await expect(browser.findElement(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[4]/ol/li[1]/a/label/div"))).to.eventually.exist;
	await delay(3000);
    await expect(browser.findElement(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[4]/ol/li[2]/a/label/div"))).to.eventually.exist;
	await delay(3000);
	await expect(browser.findElement(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[4]/ol/li[3]/a/label/div"))).to.eventually.exist;
	await delay(3000);
 });
 ...
 Then('SPP-0040 Read sub options are displayed', async () => {
	await expect(browser.findElement(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[5]/ol/li[1]/a/label/div"))).to.eventually.exist;
	await delay(3000);
    await expect(browser.findElement(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[5]/ol/li[2]/a/label/div"))).to.eventually.exist;
	await delay(3000);
	await expect(browser.findElement(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[5]/ol/li[3]/a/label/div"))).to.eventually.exist;
	await delay(3000);
 });  
 When('SPP-0040 select one or more attribute filter',async () => {		 
	 await delay(5000);
	element(by.xpath(".//*[@id='narrow-by-list']/dd[1]/ol/form/li[5]/ol/li[1]/a/label/div")).click();
	await delay(15000);
});
...
Then('SPP-0050 Product details are displayed',async () => {
	await expect(browser.findElement(by.xpath(".//*[@id='amasty-shopby-product-list']/div[1]/ol/li[1]/div/a/img"))).to.eventually.exist;
	await delay(3000);
	element(by.xpath(".//*[@id='narrow-by-list']/dd[2]/ol/form/li[1]/a/label/span")).click();
	await delay(10000);
});
...
When('SPP-0080 Click on product',async () => {
	await delay(5000);
	element(by.xpath(".//*[@id='amasty-shopby-product-list']/div[3]/ol/li/div/a/img")).click();
	await delay(25000);
});
...
Then('ICO-0020 Billing information are displayed in incart', async () => { 
	await delay(20000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/fieldset/div/div[1]/div/input")).sendKeys("Chicago illonois");
	await delay(5000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/div[3]/div/input")).sendKeys("Chicago");
	await delay(1000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/div[5]/div/select")).click();
	await delay(1000);
	element(by.xpath("html/body/main/div/main/div/div/div[3]/div[3]/div/div[2]/div/div[4]/div[1]/div[2]/div/div[1]/div/div[2]/div[1]/form/fieldset/div[5]/div/select/option[13]")).click();
	await delay(1000);
...
Then('getbronze order conformation is displayed', async () => { 
    ...
    await delay(2000);
    await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[2]/div[4]/div[3]/div[5]/button"))).to.eventually.exist;
	await delay(2000);
	await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[2]/div[4]/div[1]/div[1]/div[2]/div[1]/img[1]"))).to.eventually.exist;
	await delay(2000);
	await expect(browser.findElement(by.xpath(".//*[@class='counter amount']"))).to.eventually.exist;
...
Then('BiaY order conformation is displayed', async () => { 
	await delay(3000);
    await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[2]/div[4]/div[1]/div[5]/button"))).to.eventually.exist;
    await delay(2000);                        
    await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div[2]/div[4]/div[1]/div[1]/div[2]/div[1]/img[1]"))).to.eventually.exist;
    await delay(2000);
});
Then('7daytrial conformation is displayed', async () => { 
    ...
    await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div/div[1]/div/h1"))).to.eventually.exist;
    await delay(2000);
    await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[2]/div/div[3]/div/div[2]/a"))).to.eventually.exist;
    await delay(2000);
});
...
When('LPA-0010 Enter Parish Admin Name and password', async () => {
	await delay(5000);
	element(by.xpath(".//*[@id='header']/div/div/div/div/ul/profile-menu/div/div/span/div/login/form/input[1]")).sendKeys("yogirpatel@gmail.com");
	await delay(3000);
	element(by.xpath(".//*[@id='header']/div/div/div/div/ul/profile-menu/div/div/span/div/login/form/input[2]")).sendKeys("zoro2017");
	await delay(3000);
	element(by.xpath(".//*[@id='header']/div/div/div/div/ul/profile-menu/div/div/span/div/login/form/button")).click();
	await delay(30000);
});
...
Then('LPA-0030 Click on Current Topics and Verify with parish admin', async () => {
	...
	await delay(3000);
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[3]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[5]/div/a/img"))).to.eventually.exist;
	await delay(3000);  
});
Then('LPA-0030 Click on Youth Disciple and Verify with parish admin', async () => {
	...
	await delay(3000);
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[4]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[2]/div/a/img"))).to.eventually.exist;
	await delay(3000);
});
Then('LPA-0030 Click on espanol and Verify with parish admin', async () => {
	...
	await delay(3000);
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[5]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[5]/div/a/img"))).to.eventually.exist;
	await delay(3000);
});
...
Then('LPA-0040 Click on Watch Movies and Verify with parish admin', async () => {
	...
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[1]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
	await delay(3000);
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/segmented-page/div/div[1]/segment/div[3]/div/stripe/div/div/div[2]/div/div/div/div/div[5]/div/a/img"))).to.eventually.exist;
	await delay(3000);
});
...
Then('LPA-0050 Click on Listen audio dramas and Verify with parish admin', async () => {
	...
	await delay(6000);
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[1]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
	await delay(3000);
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[1]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[3]/div/a/img"))).to.eventually.exist;
	await delay(3000);
});
...
Then('LPA-0050 Click on Listen audio books and Verify with parish admin', async () => {
	...
	await delay(6000);
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[2]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
	await delay(3000);
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[2]/segment/div[2]/div/stripe/div/div/div[2]/div/div/div/div/div[9]/div/a/img"))).to.eventually.exist;
	await delay(3000);
});
...
Then('LPA-0050 Click on Listen espanol and Verify with parish admin', async () => {
	...
	await delay(6000);
	await expect(browser.findElement(by.xpath(".//*[@id='scroll-top']/div/div[2]/div/segmented-page/div/div[4]/segment/div[2]/div/stripe/div/div/div[1]/div[1]/h3"))).to.eventually.exist;
	await delay(3000);
...
Then('click on Talks link and verify', async () => {
    await delay(5000);
	element(by.xpath("//a[@href='https://market.beta.formed.org/watch/talks.html']")).click();
	await delay(20000);        
...
Then('ALA-0020 click on On Demand subscription in account page', async () => {
	await delay(5000);
	element(by.xpath(".//*[@id='account-nav']/ul/li[9]/a")).click();
	await delay(10000);
	await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/div[2]/div[2]/div/a"))).to.eventually.exist;
	await delay(2000);  
});
When('FFC-0320 click on cancel contribution', async () => {
	...
	await delay(5000);
	element(by.xpath("html/body/div[3]/aside[5]/div[2]/footer/button[1]")).click();
	await delay(10000);
});
When('FFC-0320 Formed Contribution status is inactive', async () => {
	await delay(15000);
	element(by.xpath(".//*[@id='account-nav']/ul/li[10]/a")).click();
	await delay(2000);
	await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/div/div[2]/div[2]/span[2]/span"))).to.eventually.exist;
	await delay(2000);
});
Then('ALA-0030 click Edit button in payment method', async () => {
	await delay(5000);
	element(by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/div[2]/div[1]/div[1]/span[2]/a")).click();
	await delay(15000);
});
...
Then('ALA-0050 Billing information from pbc', async () => {
	await delay(15000);
	element(by.xpath("//*[@id='billing_address_firstname']")).sendKeys("Fname");
	await delay(5000);
	element(by.xpath("//*[@id='billing_address_lastname']")).sendKeys("Lname");
	await delay(5000);
	element(by.xpath("//*[@id='billing_address_street']")).sendKeys("chicago ilunious");
	await delay(5000);
	element(by.xpath("//*[@id='billing_address_city']")).sendKeys("chicago");
	await delay(5000);
	element(by.xpath("//*[@id='billing_address_region_id']")).click();
	await delay(5000);
	element(by.xpath(".//*[@value='12']")).click();
	await delay(5000);
	element(by.xpath("//*[@id='billing_address_zip']")).sendKeys("60014");
	await delay(5000);
	element(by.xpath("//*[@id='billing_address_telephone']")).sendKeys("88557715158");
	await delay(5000);
	element(by.xpath("//*[@id='billing_address_authorized_by']")).sendKeys("saichraaaa");
	await delay(5000);
	element(by.xpath("html/body/div[3]/aside[1]/div[2]/footer/button")).click();
	await delay(15000);
});
Then('ALA-0060 click on Add Cupon in On demand subscription', async () => {
	element(by.xpath(".//*[@id='coupon-btn']")).click();
	await delay(5000);
...
Then('ALA-0070 click on Resend invoice', async () => {
	await delay(5000);
	element(by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div/div[1]/div/div[1]/span[2]/a")).click();
	await delay(8000);
...
Then('FFC-0120 click on On Demand Subscription', async () => {
	await delay(5000);
	await expect(browser.findElement(by.xpath("//a[@href='https://market.beta.formed.org/formed/account/']"))).to.eventually.exist;
	await delay(2000);
	element(by.xpath("//a[@href='https://market.beta.formed.org/formed/account/']")).click();
	await delay(15000);
});
When('FFC-0220 click on enable button in On Demand Subscription page', async () => {
	await delay(3000);
    element(by.xpath(".//*[@id='maincontent']/div[3]/div[1]/div[3]/div[1]/div[2]/div[2]/div/a")).click();
	await delay(10000);
});
Then('FFC-0220 Accept Terms buton is displayed', async () => {
	await delay(10000);
...
Then('FFC-0220 click on Accept Terms button', async () => {
	...
	await delay(5000);
	await expect(browser.findElement(by.xpath("html/body/div[3]/aside[3]/div[2]/footer/button[1]"))).to.eventually.exist;
	await delay(2000);
...
When('FFC-0260 click on Cancel On-demand subscription', async () => {
	element(by.xpath(".//*[@id='cancel-ondemand-btn']")).click();
	await delay(10000);
	await expect(browser.findElement(by.xpath("html/body/div[3]/aside[5]/div[2]/footer/button[1]"))).to.eventually.exist;
	await delay(2000);
});
...
When('FFC-0210 click on Edit in Formed funding', async () => {
	...
	await delay(5000);
	element(by.xpath("html/body/div[5]/aside[3]/div[2]/footer/button")).click();
	await delay(10000);
	await expect(browser.findElement(by.xpath(".//*[@id='maincontent']/div[2]/div[2]/div[1]/div/div")).getText()).to.eventually.equal('Campaign funding goal successfully changed.');
	await delay(10000);
});
});
